...
select(species, everything()) %>% 
  print()
#could also use the rename function
```
...
gapminder %>% 
  ...
  summarize(min_life = min(round(lifeExp)))  
#When using summarize, name the column first and then = then what you want the column to show
```
