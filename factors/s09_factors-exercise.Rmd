...
levels(gapminder$continent) #"Africa"   "Americas" "Asia"     "Europe"   "Oceania"#
nlevels(gapminder$continent) #5#
...
- Filter `gapminder` dataset by 5 countries of your choice. How many levels are 
  in your filtered dataset? 142

```{r}

nlevels(gapminder$country)

h_countries <- c("Italy", "United States", "Brazil", "Thailand", "Canada")
